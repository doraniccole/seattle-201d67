...
and the second element is a concatenated string that EXACTLY follows this example and uses the values 
...
function multiply(a, b) { //eslint-disable-line
    var product = a * b;
    //console.log(product)
    var msg2 = "The product of " + a + " and " + b + " is " + product + ".";
    //console.log(msg2)
    //return [product, msg2];
    return product
}
...
and the third and fourth elements are strings that EXACTLY follow this example and use the values that 
...
To do addition, use your sum() function, and to do multiplication, use your multiply() function that you've 
already created. You're going to have to be resourceful to figure out how to do this. 
...
use your sum() function that you've already created. You're going to have to be resourceful to figure out 
...
how to do this. This function should handle an array containing three elements. However, you may continue to 
